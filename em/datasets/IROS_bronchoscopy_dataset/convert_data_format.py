...
def convert_dataset_format(
    ...
    tangent_axis="z",  # "x", "y", or "z"
    normal_axis="y",  # "x", "y", or "z" different from tangent
    binormal_axis="x",  # whichever axis is left
):
    """
...
if __name__ == "__main__":
    # Example usage
    input_file = "dataset/dynamic_seq_000.txt"
    output_file = "converted_dynamic_seq_000.txt"
