...
void Tracking::TrackStats2File()
{
    ...
    f << "#Image Rect[ms], Image Resize[ms], ORB ext[ms], Stereo match[ms], Pose pred[ms], LM track[ms], KF dec[ms], Total[ms]" << endl;
...
{   
    ...
    {   auto start4 = chrono::steady_clock::now();
        ...
        if (printDuration) cout << "\tInitialization: " << duration_Initialization.count() << " milliseconds" << endl;
    }
    else
    {
        ...
        if(!mbOnlyTracking)
        {
            ...
            // print the duration of the function
            if (printDuration) cout << "\tNot TrackOnly: " << duration_TrackOnly.count() << " milliseconds" << endl;
        }
        else
        {
            ...
            // print the duration of the function
            if (printDuration) cout << "\tTrackLocalization: " << duration_TrackLocalization.count() << " milliseconds" << endl;
        }
        ...
        // print the duration of the function
        if (printDuration) cout << "\tResetLost: " << duration_ResetLost.count() << " milliseconds" << endl;
    }
    ...
    // print the duration of the function
    if (printDuration) cout << "\tStoreFrame: " << duration_StoreFrame.count() << " milliseconds" << endl;
...
bool Tracking::TrackReferenceKeyFrame()
{
    ...
    const double priorWeight = 1000.0;
    Optimizer::PoseOptimization(&mCurrentFrame, priorPose, priorWeight);
...
bool Tracking::NeedNewKeyFrame()
{
    ...
    //std::cout << "NeedNewKF: c1a=" << c1a << "; c1b=" << c1b << "; c2=" << c2 << std::endl;
    ...
    while(nCandidates>0 && !bMatch)
    {
        for(int i=0; i<nKFs; i++)
        {
            ...
            if(bTcw)
            {
                ...
                const Sophus::SE3f priorPose = GetCandidateFrame();
                const double priorWeight = 1000.0;
                int nGood = Optimizer::PoseOptimization(&mCurrentFrame, priorPose, priorWeight);
                ...
                if(nGood<50)
                {
                    ...
                    if(nadditional+nGood>=50)
                    {
                        ...
                        const Sophus::SE3f priorPose = GetCandidateFrame();
                        const double priorWeight = 1000.0;
                        nGood = Optimizer::PoseOptimization(&mCurrentFrame, priorPose, priorWeight);
